...
import de.idos.updates.repository.FtpRepository;
...
public class UpdatesSteps {
    ...
    private final FtpServer ftpServer = new FtpServer();
    ...
    public void an_FTP_Server_with_new_versions() throws Throwable {
        ftpServer.start();
    }

    @Given("^a FTP-repository for that server$")
    public void an_FTP_Repository_for_that_server() throws Throwable {
        Repository repository = new FtpRepository("localhost");
        updateSystemBuilder.useRepository(repository);
    }
